...
namespace WpfNaverMovieFinder
{
    ...
    {
        bool IsFavorite = false;   //네이버 api로 검색한건지, 즐겨찾기DB에서 온 것인지 확인할 값
        ...
        private void btnSearch_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            {
                stsResult.Content = "검색할 영화명을 입력, 검색버튼을 눌러주ㅅㅄ오. 휴먼";
                //MessageBox.Show("검색할 영화명을 입력, 검색버튼을 눌러주ㅅㅄ오. 휴먼");
                Commons.ShowMessageAsync("검색", "검색할 영화명을 입력, 검색버튼을 눌러주ㅅㅄ오. 휴먼");
                return;
            }
        ...
        {
            string clientID = "W2d1nM2mihmiM_dWntwA";
            string clientSecret = "dSXsLpdJJH";
            ...
            try
            {
                ...
                request.Headers.Add("X-Naver-Client-Id", clientID); //뻐킹 중요!
                request.Headers.Add("X-Naver-Client-Secret", clientSecret); //애솔 중요!
        ...
        private void btnWatchListWatchTrailer_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            if (grdResult.SelectedItems.Count == 0)
            {
